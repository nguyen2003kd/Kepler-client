  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild disabled={isLoading}>
        <Button
          variant="ghost"
          className="relative p-1 h-auto rounded-full hover:bg-red-50/80 transition-all duration-200 group disabled:opacity-100"
          disabled={isLoading}
        >
          <div className="relative">
            {isLoading ? (
              <div className="h-9 w-9 ring-2 ring-red-100 rounded-full bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center">
                <Loader2 className="h-4 w-4 animate-spin text-white" />
              </div>
            ) : (
              <>
                <Avatar className="h-9 w-9 ring-2 ring-red-100 group-hover:ring-red-300 group-hover:ring-offset-1 group-data-[state=open]:ring-red-300 group-data-[state=open]:ring-offset-1 transition-all duration-300 cursor-pointer group-hover:scale-110 group-hover:shadow-lg group-data-[state=open]:scale-110 group-data-[state=open]:shadow-lg">
      ...
      <DropdownMenuContent
        ...
        sideOffset={8}
      >
        <DropdownMenuLabel className="font-normal p-3 bg-gradient-to-r from-red-50 to-indigo-50 rounded-lg mb-2">
        ...
        <div className="space-y-1">
          <DropdownMenuItem
            ...
            className="cursor-pointer rounded-md px-3 py-2.5 hover:bg-red-50 hover:text-red-700 transition-colors group"
          >
            <User className="mr-3 h-4 w-4 text-gray-500 group-hover:text-red-600 transition-colors" />
          ...
          <DropdownMenuItem
            ...
            className="cursor-pointer rounded-md px-3 py-2.5 hover:bg-red-50 hover:text-red-700 transition-colors group"
          >
            <Settings className="mr-3 h-4 w-4 text-gray-500 group-hover:text-red-600 transition-colors" />
          ...
          <Can I="view" a="work-schedule">
            <DropdownMenuItem
              ...
              className="cursor-pointer rounded-md px-3 py-2.5 hover:bg-red-50 hover:text-red-700 transition-colors group"
            >
              <Calendar className="mr-3 h-4 w-4 text-gray-500 group-hover:text-red-600 transition-colors" />
