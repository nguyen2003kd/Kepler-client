export const KEPLER_CONFIG = {
  ...
  projectUrl: "https://kepler-vietprodev.vercel.app",
...
export const NAV_ITEMS: NavItem[] = [
  { href: "/", label: "Trang chủ" },
  {
    ...
    label: "Mua bán",
    children: [
      { href: "/apartments-for-sale?type=nha-pho", label: "Nhà phố" },
      { href: "/apartments-for-sale?type=can-ho", label: "Căn hộ" },
      { href: "/apartments-for-sale?type=dat-nen", label: "Đất nền" },
      { href: "/apartments-for-sale?type=biet-thu", label: "Biệt thự" },
      { href: "/apartments-for-sale?type=shophouse", label: "Shophouse" },
      { href: "/apartments-for-sale?type=officetel", label: "Officetel" },
    ],
  },
  {
    ...
    label: "Cho thuê",
    children: [
      { href: "/apartments-for-rent?type=nha-thue", label: "Nhà cho thuê" },
      { href: "/apartments-for-rent?type=can-ho", label: "Căn hộ cho thuê" },
      { href: "/apartments-for-rent?type=van-phong", label: "Văn phòng" },
      { href: "/apartments-for-rent?type=mat-bang", label: "Mặt bằng" },
      { href: "/apartments-for-rent?type=biet-thu", label: "Biệt thự" },
    ],
  },
...
const PRJ_IMG = {
  ...
  p4: "https://picsum.photos/seed/prj4/1200/800",
...
export const PROJECTS: ProjectInfo[] = [
  { id: "prj-001", slug: "vinhomes-grand-park", title: "Vinhomes Grand Park", type: "Khu đô thị", location: "Long Thạnh Mỹ, Quận 9, TP.HCM", status: "Đang mở bán", scale: "44.000 căn", img: PRJ_IMG.p1, images: [PRJ_IMG.p1, PRJ_IMG.prjInt1, PRJ_IMG.prjInt2, PRJ_IMG.prjInt3, PRJ_IMG.prjInt4], priceRange: "2,8 - 12 tỷ", handover: "2025", description: "Khu đô thị sinh thái thông minh tại Quận 9, TP.HCM với quy mô 271,8 ha. Đầy đủ tiện ích: trường học, bệnh viện, công viên, TTTM.", amenities: ["Trường học quốc tế", "Bệnh viện", "Công viên", "TTTM", "Hồ bơi", "Gym"] },
  { id: "prj-002", slug: "celesta-rise", title: "Celesta Rise", type: "Khu đô thị", location: "Nhà Bè, TP.HCM", status: "Đang mở bán", scale: "1.200 căn", img: PRJ_IMG.p2, images: [PRJ_IMG.p2, PRJ_IMG.prjInt2, PRJ_IMG.prjInt3, PRJ_IMG.prjInt4], priceRange: "3,5 - 8 tỷ", handover: "2024", description: "Khu đô thị mới tại Nhà Bè với thiết kế hiện đại, không gian xanh mát. Hạ tầng hoàn thiện, giao thông thuận tiện.", amenities: ["Công viên", "Hồ bơi", "Khu vui chơi", "An ninh 24/7"] },
  { id: "prj-003", slug: "method-central-park", title: "Method Central Park", type: "Căn hộ", location: "Bình Thạnh, TP.HCM", status: "Đang mở bán", scale: "3.000 căn", img: PRJ_IMG.p3, images: [PRJ_IMG.p3, PRJ_IMG.prjInt1, PRJ_IMG.prjInt3, PRJ_IMG.prjInt4], priceRange: "4 - 15 tỷ", handover: "2025", description: "Vị trí đắc địa quận Bình Thạnh, view sông Sài Gòn. Thiết kế hiện đại với đầy đủ tiện ích.", amenities: ["View sông", "Pool", "Gym", "Coffee shop", "Co-working"] },
  { id: "prj-004", slug: "the-rive-gate", title: "The Rive Gate", type: "Khu đô thị", location: "Quận 9, TP.HCM", status: "Đang mở bán", scale: "800 căn", img: PRJ_IMG.p4, images: [PRJ_IMG.p4, PRJ_IMG.prjInt1, PRJ_IMG.prjInt2, PRJ_IMG.prjInt3], priceRange: "3,2 - 7 tỷ", handover: "2024", description: "Khu đô thị biệt lập tại Quận 9 với thiết kế cảnh quan xanh, hồ điều hòa. Phù hợp gia đình muốn không gian sống yên tĩnh.", amenities: ["Hồ điều hòa", "Công viên", "Khu BBQ", "An ninh"] },
];
