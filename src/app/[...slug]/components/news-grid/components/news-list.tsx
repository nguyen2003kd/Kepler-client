            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                <div>
                  {/* Badge */}
                  <div className="mb-3">
                    <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-primary/80 text-white text-xs font-bold rounded-full shadow-xl backdrop-blur-sm border border-white/20 group-hover:scale-105 transition-transform">
                      {t("latest")}
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <div className="text-white/90 text-sm md:text-base mb-3 md:mb-4 line-clamp-2 leading-relaxed drop-shadow-md max-w-[60%]">
