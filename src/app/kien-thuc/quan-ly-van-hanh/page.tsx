...
const CATEGORY_SLUG = "quan-ly-van-hanh";

const SUB_SECTIONS = [
  {
    key: "quan-ly-toa-nha",
    title: "Quản lý tòa nhà",
    description: "Vận hành, bảo trì, an ninh và tiếp nhận bàn giao tòa nhà.",
    tag: "quản lý tòa nhà",
  ...
  },
  {
    ...
    description: "Chiến lược danh mục, tối ưu hiệu suất và vòng đời tài sản.",
    tag: "quản lý tài sản",
    accent: "from-amber-500 to-orange-600",
  },
  {
    key: "facility-operation",
    title: "Facility & Operation",
    description: "Tiêu chuẩn FM quốc tế, KPI vận hành và ESG.",
    tag: "facility & operation",
...
export default function QuanLyVanHanhPage() {
  ...
  const stats = [
    ...
    { value: SUB_SECTIONS.length, suffix: "", label: "Lĩnh vực vận hành" },
    { value: 25, suffix: "+", label: "Năm kinh nghiệm" },
    { value: 100, suffix: "+", label: "Tòa nhà quản lý" },
  ];
    ...
    <div className="bg-white">
      ...
      <section className="relative h-[70vh] min-h-[460px] max-h-[640px] overflow-hidden bg-[#1a1a1a]">
        <div className="absolute inset-0">
          <img
            src="/images/video-section-1.png"
            alt={category.name}
          ...
          <div className="max-w-[1400px] w-full mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="mt-5 md:mt-6 text-base md:text-lg text-white/80 leading-relaxed max-w-[60ch]">
                ...
                vận hành Kepler Group, áp dụng tiêu chuẩn quốc tế vào thị trường Việt Nam.
              </p>
      ...
      {/* ===== 4. ARTICLES (ref: news-section with tabs + sidebar) ===== */}
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
              Cần tư vấn{" "}
              <span className="text-red-500">quản lý &amp; vận hành</span> tòa nhà?
            </h2>
            <p className="mt-6 text-gray-400 text-base leading-relaxed max-w-[60ch]">
              Đội ngũ Kepler sẵn sàng đồng hành từ tiếp nhận bàn giao, vận hành
              hàng ngày đến tối ưu hiệu suất tài sản — áp dụng tiêu chuẩn quốc tế,
