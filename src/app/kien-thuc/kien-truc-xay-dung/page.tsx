...
const CATEGORY_SLUG = "kien-truc-xay-dung";

const SUB_SECTIONS = [
  {
    key: "thiet-ke",
    title: "Thiết kế",
    description: "Thiết kế kiến trúc, nội thất và concept công trình.",
    tag: "thiết kế",
  ...
  },
  {
    key: "thi-cong",
    title: "Thi công",
    description: "Quản lý, giám sát và kiểm soát chất lượng thi công.",
    tag: "thi công",
  ...
  },
  {
    ...
    description: "Nâng cấp, retrofit và tái định vị công trình cũ.",
    tag: "cải tạo",
...
export default function KienTrucXayDungPage() {
  ...
  const stats = [
    { value: allArticles.length, suffix: "", label: "Bài viết chuyên sâu" },
    { value: SUB_SECTIONS.length, suffix: "", label: "Lĩnh vực kiến trúc" },
    { value: 50, suffix: "+", label: "Dự án thiết kế" },
    { value: 100, suffix: "+", label: "Công trình thi công" },
  ];
  ...
  return (
    <div className="bg-white">
          ...
          <div className="max-w-[1400px] w-full mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-5">
                <div className="w-12 h-12 rounded-lg bg-rose-600/90 backdrop-blur-sm flex items-center justify-center shrink-0">
              ...
              <p className="mt-5 md:mt-6 text-base md:text-lg text-white/80 leading-relaxed max-w-[60ch]">
                {category.description} — kiến thức thực chiến từ đội ngũ
                kiến trúc sư và kỹ sư Kepler Group, kết hợp thẩm mỹ và kỹ thuật.
              </p>
      ...
      <section id="articles" className="bg-gray-50 py-16 pt-20 scroll-mt-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <div className="mt-4 h-1 w-20 rounded-full bg-rose-500" />
          </motion.div>
                      ...
                      <div className="md:w-3/5 p-5 md:p-6 flex flex-col justify-between">
                        <div>
                          <div className="flex items-center gap-3 mb-3">
                            <span className="inline-block px-2.5 py-0.5 bg-rose-50 text-rose-600 text-xs font-semibold rounded-full uppercase tracking-wider">
                              {article.category}
                            </span>
                          ...
                          <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 line-clamp-2 hover:text-rose-600 transition-colors">
                        ...
                        <Link
                          href={`/kien-thuc/${article.slug}`}
                          className="inline-flex items-center text-rose-600 hover:text-rose-700 text-sm font-semibold transition-colors"
                        >
                          Đọc tiếp →
                        </Link>
                      </div>
              ...
              {filteredArticles.length === 0 && (
                <div className="py-16 text-center bg-white rounded-lg border border-gray-100 shadow-sm">
                  <p className="text-gray-500 text-sm">
                    Chưa có bài viết trong lĩnh vực này.
                  </p>
                </div>
              )}
            </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    return (
                      ...
                      >
                        <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center shrink-0 group-hover:bg-rose-600 transition-colors">
                          <Icon className="w-4.5 h-4.5 text-white" />
                        </div>
                        <span className="text-sm font-semibold text-white group-hover:text-gray-900 transition-colors flex-1">
                          {m.label}
                        </span>
                        <ArrowUpRight className="w-4 h-4 text-white/50 group-hover:text-rose-600 transition-colors" />
                      </Link>
                    );
                  })}
                </div>
      ...
      <section className="relative bg-gray-900 py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(244,63,94,0.12),_transparent_70%)]" />
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-rose-500/30 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-rose-500/30 to-transparent" />
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
              Cần tư vấn{" "}
              <span className="text-rose-500">thiết kế &amp; thi công</span> công trình?
            </h2>
            <p className="mt-6 text-gray-400 text-base leading-relaxed max-w-[60ch]">
              Đội ngũ kiến trúc sư và kỹ sư Kepler đồng hành từ concept thiết kế,
              thi công đến cải tạo nâng hạng — kết hợp thẩm mỹ, kỹ thuật và
              kiểm soát ngân sách cho mọi quy mô công trình.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link
                href="/dat-lich-tu-van"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-rose-600 text-white text-sm font-semibold rounded-full hover:bg-rose-500 transition-all hover:shadow-[0_0_30px_rgba(244,63,94,0.4)] group"
              >
                Đặt lịch tư vấn
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
...
function FilterTab({
  ...
  const activeColor = accent === "rose" ? "border-rose-600" : "border-red-600";
  const badgeActive = accent === "rose" ? "bg-rose-50 text-rose-600" : "bg-red-50 text-red-600";
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      ...
      <span
        className={`ml-2 text-xs px-1.5 py-0.5 rounded-full ${
          active ? badgeActive : "bg-gray-100 text-gray-500"
        }`}
      >
        {count}
      </span>
