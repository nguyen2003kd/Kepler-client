    ...
    return (
      <div
        ...
        className={cn(
          ...
          isMorning ? "border-orange-100 hover:border-orange-300 dark:border-orange-900/20 dark:hover:border-orange-800/40" : "border-red-100 hover:border-red-300 dark:border-red-900/20 dark:hover:border-red-800/40"
        )}
      >
        <div className={cn(
          ...
          isMorning ? "bg-orange-500" : "bg-red-500"
        )} />
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-4 md:items-center">
          <div className="flex md:flex-col md:w-32 shrink-0 items-center md:items-start gap-3 md:gap-1">
             <div className={cn(
               ...
               isMorning ? "bg-orange-50 text-orange-600 dark:bg-orange-500/10 dark:text-orange-400" : "bg-red-50 text-red-600 dark:bg-red-500/10 dark:text-red-400"
             )}>
          ...
          <div className="flex-1 space-y-3">
            ...
            {event.tasks && (
              <div className="flex items-start gap-2 rounded-lg bg-red-50 dark:bg-red-950/30 px-3 py-2 text-sm">
                <span className="shrink-0 text-xs font-semibold text-red-600 dark:text-red-400 uppercase mt-0.5">{t("workSchedule.tasks")}</span>
                <span className="text-slate-700 dark:text-red-200 leading-relaxed">{event.tasks}</span>
              </div>
            )}
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="mb-8 flex items-center space-x-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-red-600 text-white shadow-lg shadow-red-600/20 dark:bg-red-600/20 dark:text-red-400 dark:shadow-none">
        ...
        <div className="space-y-10">
          ...
          {/* Chiều Section */}
          <div className="relative pl-6 sm:pl-8">
            <div className="absolute left-0 top-0 bottom-0 w-px bg-red-100 dark:bg-red-900/30" />
            <div className="absolute left-[-4px] top-1.5 h-2 w-2 rounded-full ring-4 ring-red-50 bg-red-500 dark:ring-red-900/20" />
            <h4 className="mb-6 text-sm font-bold text-red-600 dark:text-red-400 uppercase tracking-widest flex items-center gap-2">
              {t("workSchedule.afternoon")} {afternoonEvents.length > 0 && <span className="bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 px-2 py-0.5 rounded-full text-xs">{afternoonEvents.length}</span>}
            </h4>
