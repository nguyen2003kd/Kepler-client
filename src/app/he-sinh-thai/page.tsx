// Trang cha /he-sinh-thai đã bị comment — chỉ dùng dropdown các trang con.
// Redirect về trang con đầu tiên nếu user truy cập trực tiếp /he-sinh-thai

import { redirect } from "next/navigation";

export default function EcosystemPageRedirect() {
  redirect("/he-sinh-thai/kepler-property");
}
