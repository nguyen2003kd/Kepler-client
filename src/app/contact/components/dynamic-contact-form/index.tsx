...
export default function DynamicContactForm({ formType }: DynamicContactFormProps) {
  ...
  const fallbackAddresses: AddressItem[] = [
    ...
    },
    {
      ...
      address: "Số F2.67-F2.68 Nguyễn Thị Sáu, Phường Hưng Phú, Thành phố Cần Thơ",
      phone: "0292. 3918 217 – 3918 218",
    },
    {
      id: 6,
      name: "Văn phòng đại diện Miền Trung",
      address: "Số STH 27.18, Đường 8E, Khu đô Thị mới Lê Hồng Phong II, Phường Nam Nha Trang, Tỉnh Khánh Hòa",
